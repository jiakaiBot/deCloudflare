...
| # | Mastodon User | Links |
| --- | --- | --- |
| 1 | obapom@pawoo.net | 11,636 |
| 2 | UnitooWebRadio@botsin.space | 11,275 |
...
| 33 | mauthausengusen@slippy.xyz | 710 |
...
| --- | --- | --- | --- |
| 1 | twitter.com |   | 69,010 |
| 2 | t.co |   | 59,672 |
| 3 | youtube.com |   | 19,594 |
| 4 | youtu.be |   | 16,143 |
| 5 | unitoo.it |   | 11,838 |
| 6 | yahoo.co.jp |   | 11,202 |
| 7 | tinyurl.com | 🌩 | 9,480 |
| 8 | pixiv.net | 🌩 | 8,872 |
| 9 | ycombinator.com | 🌩 | 7,219 |
| 10 | weibo.com |   | 6,680 |
| 11 | github.com |   | 5,861 |
| 12 | nhk.or.jp |   | 5,850 |
...
- *50,245* Mastodon users posted *2,812,415* public toots. (about *90,723* toots per day)
  - Above number include toots which has no link.
- Now let's focus on *Mastodon toots which has any links*.

![](../image/bully.jpg)

- *24,617* Mastodon users posted *623,035* public toots _with any links_.
...
- Inside *24,617* Mastodon users,
  ...
  - There are *13,429* users who NEVER shared Cloudflare links. (*54.6*%)
- Inside *623,035* public toots,
  - There are *32,137* base domains. ("_base_": both `www.youtube.com` `m.youtube.com` will be treated as `youtube.com`)
