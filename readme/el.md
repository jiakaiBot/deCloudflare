...
Το We ξέρει για την ύπαρξη πλαστών λογαριασμών που πλαστογραφούν τα επίσημα κανάλια μας, είτε πρόκειται για Twitter, Facebook, Mastodon, Github, Gitea, Patreon, OpenCollective, Villages κ.λπ.
